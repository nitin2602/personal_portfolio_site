						...
						<BlurFade delay={BLUR_FADE_DELAY}>
							<Avatar className="size-36 border">
								<AvatarImage
									alt={DATA.name}
									src={DATA.avatarUrl}
									className="cursor-pointer object-contain transition-transform duration-200 hover:scale-105 hover:grayscale-0 p-0"
								/>
				...
				<div className="grid items-center justify-center gap-4 px-4 text-center md:px-6 w-full py-12">
					<BlurFade delay={BLUR_FADE_DELAY * 16}>
						<div className="space-y-3">
							...
							<p className="text-muted-foreground md:text-l/relaxed lg:text-base/relaxed xl:text-l/relaxed">
								If you’d like to connect, LinkedIN is an efficient way to reach me. Feel free to
								send me a message{" "}
								<Link
									target="_blank"
